source = tester.cpp pinger.cpp printer.cpp simple_container.cpp series.cpp buffer.cpp throughput.cpp delay.cpp ensemble_container.cpp
objects = pinger.o printer.o simple_container.o series.o buffer.o throughput.o delay.o ensemble_container.o
executables = tester
